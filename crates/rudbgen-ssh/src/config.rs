...
//! [`TunnelConfig`](rudbgen_core::TunnelConfig) a connection profile carries.
...
use rudbgen_core::{TunnelAuth, TunnelConfig};
...
impl TunnelSpec {
    ...
    /// [`SecretSlot::Tunnel`](rudbgen_core::SecretSlot::Tunnel) — a password or
