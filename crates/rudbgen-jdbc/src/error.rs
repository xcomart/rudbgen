...
//!   README.md, "Response envelope") and carries a `SQLSTATE`, a vendor code and a cause chain;
...
pub enum Error {
    ...
    /// down instead of the process (the bridge's `README.md`, "Concurrency"). The session
    /// is dead afterwards.
...
/// The ERROR envelope of the bridge's `README.md`, as the bridge sends it.
///
