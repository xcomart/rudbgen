...
public abstract class ColumnWriter {
     ...
     * @param rowInCursor absolute row index within the cursor. No writer left
     *                    here reads it -- it addressed rudbman's LOB references
     *                    (architecture.md D3) -- but it stays in the signature
     *                    so this codec keeps diffing cleanly against rudbman's
