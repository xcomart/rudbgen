...
//!
//! The hosts recorded here are the SSH bastions a connection profile tunnels
//! through, see [`TunnelConfig`](crate::TunnelConfig).
...
const FILE_HEADER: &str = "# rudbgen known hosts: <host> <port> <algorithm> <fingerprint>";
