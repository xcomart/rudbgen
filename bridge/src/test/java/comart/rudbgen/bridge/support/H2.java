package comart.rudbgen.bridge.support;

import com.google.gson.JsonElement;
import com.google.gson.JsonObject;
import comart.rudbgen.bridge.Bridge;
import comart.rudbgen.bridge.Json;
import comart.rudbgen.bridge.Ops;
...
public final class H2 {
    ...
    public static String freshUrl() {
        return "jdbc:h2:mem:rudbgen" + SEQ.incrementAndGet() + ";DB_CLOSE_DELAY=-1";
    }
