...
/// Version of the `rudbgen` binary, taken from its `Cargo.toml`.
const VERSION: &str = env!("CARGO_PKG_VERSION");

/// Project home page, opened by the repository button.
const REPOSITORY_URL: &str = "https://github.com/xcomart/rudbgen";

/// Label of the repository button; the URL without its scheme.
const REPOSITORY_LABEL: &str = "github.com/xcomart/rudbgen";
