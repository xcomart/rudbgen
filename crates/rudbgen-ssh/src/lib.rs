//! SSH local port forwarding for rudbgen.
//!
...
//! use std::sync::Arc;
//!
//! use rudbgen_ssh::{AcceptAllVerifier, SshAuth, SshTunnel, TunnelSpec};
//!
...
//! application layer (architecture document, §3; rudbman's, §9.3).
//!
...
//! [`rudbgen_core::KnownHosts`] and the "do you trust this fingerprint?" dialog
//! stays in the UI.
//!
