...
```powershell
winget validate --manifest packaging\winget\0.1.5
```
...
```powershell
winget install --manifest packaging\winget\0.1.5
```
...
```powershell
$dst = "<fork>\manifests\x\Xcomart\Rudbgen\0.1.5"
New-Item -ItemType Directory -Force $dst
Copy-Item packaging\winget\0.1.5\*.yaml $dst
```
