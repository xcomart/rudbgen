...
//! [`TreeSource`](rudbgen_ui::TreeSource) — and for a sharper reason than reuse:
//! the thing a real grid is showing is a `rudbgen-jdbc` batch, and a crate that
...
//!
//! [`Theme::grid_null`]: rudbgen_ui::Theme#structfield.grid_null
...
pub struct GridColumn<'a> {
    ...
    ///
    /// Drawn in [`Theme::grid_pk`](rudbgen_ui::Theme#structfield.grid_pk). It is
...
pub struct CellLabel {
    ...
    /// [`Theme::grid_null`](rudbgen_ui::Theme#structfield.grid_null) instead of
