...
impl EditorThemeRegistry {
    ...
    /// Whether `id` names an editor theme that ships with rudbgen.
    ///
    ...
    /// rudbgen happens to ship rather than a rule. A `tokyo-night.json` the user
...
mod tests {
    ...
    ///
    /// The example is deliberately a palette rudbgen does *not* ship — folke's
