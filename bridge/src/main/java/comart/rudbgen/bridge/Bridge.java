...
import comart.rudbgen.bridge.meta.Describe;
import comart.rudbgen.bridge.meta.SessionInfo;
...
/**
 * The single JNI entry point of the bridge (README.md, "Entry point").
 *
...
public final class Bridge {
     ...
     * @return the response envelope of README.md, "Response envelope"
     */
    ...
    private static byte[] dispatch(int op, long handle, long arg, byte[] req) throws Exception {
        switch (op) {
            ...
            // 0x25 and 0x40..0x42 fall through to the default arm: they are
            // rudbman's LOB and job frames, retired here (Ops), and an old
            // client sending one should hear "unknown", not "not implemented".
            default:
