...
pub struct ExecuteResult {
    ...
    ///
    /// Named after the bridge's `README.md`; the wire member is
    /// `has_more`.
...
/// three members it needs per kind, and modelling nine metadata shapes in
...
impl Value<'_> {
    ...
    /// prints as `0.1`. Binary values become uppercase hex.
